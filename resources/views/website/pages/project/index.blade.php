    ...
    <div class="container py-5 px-lg-5">
        ...
        <div class="row g-4 portfolio-container">
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-2.jpg" alt="">
                        <div class="portfolio-overlay">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-3.jpg" alt="">
                        <div class="portfolio-overlay">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-4.jpg" alt="">
                        <div class="portfolio-overlay">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-5.jpg" alt="">
                        <div class="portfolio-overlay">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                <div class="rounded overflow-hidden">
                    <div class="position-relative overflow-hidden">
                        <img class="{{ asset('front-assets') }}/img-fluid w-100" src="{{ asset('front-assets') }}/img/portfolio-6.jpg" alt="">
                        <div class="portfolio-overlay">
